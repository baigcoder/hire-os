 ...
 */
export const createPaddleTransaction = async (priceId, customerId = null, metadata = {}) => {
    ...
    try {
        ...
        return {
            success: false,
            error: error.response?.data?.error?.detail || 'Failed to create transaction'
        };
    }
};
...
export const getPaddlePlans = () => {
    return [
        ...
        },
        {
            ...
            priceUSD: 54,
            popular: true,
            features: ['20 Job Postings', '5 Recruiter Accounts', 'Video Interviews', 'AI Recommendations'],
        ...
        },
        {
            ...
            price: 40000,
            priceUSD: 143,
            features: ['Unlimited Postings', 'Unlimited Recruiters', 'API Access', 'Dedicated Manager'],
