import { uploadImage, uploadProfilePhoto, uploadCompanyLogo, uploadCompanyCover, deleteImage } from '../utils/cloudinary.js';
...
export const uploadCompanyLogoController = async (req, res) => {
    try {
        ...
        const isRecruiter = company.recruiters.some(r => r.userId.toString() === userId);
