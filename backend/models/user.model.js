...
const userSchema = new mongoose.Schema({
    ...
    role: {
        ...
        enum: {
            ...
            message: 'Role must be student, recruiter, company_admin, or super_admin'
        },
    ...
    subscriptionEvents: [{
        event: {
            type: String,
            enum: ['trial_started', 'trial_expired', 'subscription_started', 'subscription_expired', 'subscription_renewed', 'subscription_cancelled']
        },
        date: {
            type: Date,
            default: Date.now
