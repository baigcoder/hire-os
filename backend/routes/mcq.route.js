...
router.route('/generate/:applicationId').post(isAuthenticated, isRecruiter, generateMCQTest);
router.route('/results/:testId').get(isAuthenticated, isRecruiter, getMCQTestResults);
...
router.route('/:testId/suspicious').post(isAuthenticated, reportSuspiciousActivity);
