...
import isAuthenticated, { isCompanyAdmin } from '../middlewares/isAuthenticated.js';
...
router.post('/refund/:transactionId', isAuthenticated, isCompanyAdmin, processRefund);
