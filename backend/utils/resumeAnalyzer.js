...
const extractEducation = (text) => {
  ...
  const levels = [
    ...
    {
      keywords: ["master", "msc", "mba", "ms ", "m.s."],
      level: "Master",
      score: 85,
    },
    {
      keywords: ["bachelor", "bsc", "b.sc", "b.s.", "bs ", "undergraduate"],
      level: "Bachelor",
      score: 70,
    },
...
const gpt5Analysis = async (resumeText, job) => {
  ...
  try {
    ...
    return {
      ...
      keySkillsMatch:
        analysis.skills?.matched || analysis.skills?.technical || [],
      missingSkills: analysis.skills?.missing || [],
      experienceMatch: analysis.scoreBreakdown?.experience
        ? Math.round(analysis.scoreBreakdown.experience * 4)
        : 70,
      educationMatch: analysis.scoreBreakdown?.education
        ? Math.round(analysis.scoreBreakdown.education * 6.67)
        : 60,
