...
import { Briefcase, Clock, Building2, ExternalLink, FileText } from 'lucide-react'

const statusConfig = {
    pending: { bg: 'bg-gray-500/10', text: 'text-gray-400', border: 'border-gray-500/30', label: 'PENDING' },
    reviewing: { bg: 'bg-blue-500/10', text: 'text-blue-400', border: 'border-blue-500/30', label: 'REVIEWING' },
    under_review: { bg: 'bg-blue-500/10', text: 'text-blue-400', border: 'border-blue-500/30', label: 'REVIEWING' },
    shortlisted: { bg: 'bg-purple-500/10', text: 'text-purple-400', border: 'border-purple-500/30', label: 'SHORTLISTED' },
    interview: { bg: 'bg-[#FFD700]/10', text: 'text-[#FFD700]', border: 'border-[#FFD700]/30', label: 'INTERVIEW' },
    hired: { bg: 'bg-emerald-500/10', text: 'text-emerald-400', border: 'border-emerald-500/30', label: 'HIRED' },
    accepted: { bg: 'bg-emerald-500/10', text: 'text-emerald-400', border: 'border-emerald-500/30', label: 'ACCEPTED' },
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-gray-500 font-mono tracking-wider">TRACK YOUR JOB APPLICATIONS</p>
                    </div>
                </div>
                ...
                <table className="w-full">
                    <thead>
                        <tr className="border-b border-white/5 bg-white/5">
                            <th className="text-left py-3 px-4 text-[10px] font-mono text-gray-500 uppercase tracking-wider">DATE</th>
                            <th className="text-left py-3 px-4 text-[10px] font-mono text-gray-500 uppercase tracking-wider">JOB ROLE</th>
                            <th className="text-left py-3 px-4 text-[10px] font-mono text-gray-500 uppercase tracking-wider">COMPANY</th>
                            <th className="text-right py-3 px-4 text-[10px] font-mono text-gray-500 uppercase tracking-wider">STATUS</th>
                        </tr>
                    </thead>
                        ...
                        {allAppliedJobs.map((appliedJob, index) => {
                            ...
                            return (
                                <motion.tr
                                    ...
                                    onClick={() => appliedJob?.job?._id && navigate(`/description/${appliedJob.job._id}`)}
                                >
                                    ...
                                    <td className="py-3 px-4 text-right">
                                        <Badge className={`${statusStyle.bg} ${statusStyle.text} ${statusStyle.border} border font-mono text-[10px]`}>
                                            {statusStyle.label}
                                        </Badge>
                                    </td>
                                </motion.tr>
