            ...
            <div className="pt-32 pb-12 border-b border-white/10 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 relative z-10">
                    ...
                    <p className="text-sm text-gray-500 font-mono max-w-xl">
                        Explore curated opportunities. AI-matched positions for precision career moves.
                    </p>
                </div>
            </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                    ...
                    {allJobs.length === 0 && (
                        <div className="col-span-full py-16 text-center text-gray-600 bg-[#111111] rounded-sm border border-white/10">
                            ...
                            <p className="text-sm font-medium uppercase tracking-wider">No results found</p>
                            <p className="text-xs text-gray-500 font-mono mt-1">Try different search parameters</p>
                        </div>
                    )}
                </div>
            </div>
