    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <motion.div style={{ rotateX, rotateY, perspective: 1000 }}>
          ...
          >
            Access exclusive opportunities with the world's most prestigious
            companies.
            <span className="text-white font-medium block mt-2">
              Where elite talent meets premium careers.
            </span>
          </motion.p>
        ...
        >
          {stats.map((stat, idx) => (
            <div
              key={idx}
              className="flex flex-col items-center gap-2 group cursor-default hover:transform hover:translate-y-[-5px] transition-transform duration-300"
            >
        ...
        >
          <p className="text-xs text-gray-600 uppercase tracking-[0.2em] mb-8 font-bold">
