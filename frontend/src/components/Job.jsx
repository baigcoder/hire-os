...
import { Bookmark, MapPin, Clock, DollarSign, Building2, ArrowRight, Users, Sparkles } from 'lucide-react'
                ...
                <div className="flex items-start gap-6 relative z-10">
                    ...
                    <div className="w-16 h-16 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 overflow-hidden group-hover:border-yellow-500/30 transition-colors">
                        {job?.company?.logo ? (
                            ...
                            <Building2 size={32} className="text-gray-500 group-hover:text-yellow-500 transition-colors" />
                        )}
                    </div>
                        ...
                        <div className="flex items-start justify-between gap-4">
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    <p className="text-sm font-medium text-gray-400">{job?.company?.name}</p>
        ...
        >
            ...
            <div className="flex items-start justify-between mb-6 relative z-10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-sm font-semibold text-gray-200 group-hover:text-white transition-colors">{job?.company?.name}</p>
            ...
            <div className="flex flex-wrap gap-2 mb-6 relative z-10">
                ...
                <span className="px-2.5 py-1 rounded-md bg-white/5 border border-white/10 text-xs text-white font-medium flex items-center gap-1.5">
                    <DollarSign size={12} className="text-yellow-500" /> {formatSalary(job?.salary)}
                </span>
            </div>
