                  ...
                  >
                    ...
                    <div className="pt-6 border-t border-white/5">
                      ...
                      <p className="text-xs text-gray-500 mb-4">
                        Help other users by sharing feedback about HIRE.OS
                      </p>
                      <WriteReviewButton />
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    >
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          handleSettingChange("interviewReminders", v)
                        }
                      />
                    </SettingRow>
                    ...
                    >
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          handleSettingChange("marketingEmails", v)
                        }
                      />
                    </SettingRow>
                  ...
                  >
                    ...
                    >
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          handleSettingChange("profileVisible", v)
                        }
                      />
                    </SettingRow>
                    ...
                    >
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          handleSettingChange("showEmail", v)
                        }
                      />
                    </SettingRow>
                    ...
                    >
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          handleSettingChange("showPhone", v)
                        }
                      />
                    </SettingRow>
                    ...
                    >
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          handleSettingChange("allowMessages", v)
                        }
                      />
                    </SettingRow>
                    ...
                    <div className="mt-6 pt-6 border-t border-white/5">
                      ...
                      <div className="flex gap-3">
                        <Button
                          variant="outline"
                          className="border-white/10 text-gray-400 rounded-sm text-xs uppercase tracking-wider"
                        >
                        ...
                        <Button
                          variant="outline"
                          className="border-red-500/30 text-red-400 rounded-sm text-xs uppercase tracking-wider hover:bg-red-500/10"
                        >
