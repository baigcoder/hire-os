...
import { Loader2, X, Upload, FileText, Check, User, Mail, Phone, FileEdit, Sparkles, Camera, Image as ImageIcon } from 'lucide-react'
                ...
                <DialogHeader className="sticky top-0 z-10 bg-gradient-to-r from-emerald-600 to-emerald-500 p-5 rounded-t-2xl">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-emerald-100">Keep your information up to date</p>
                        </div>
                    </div>
                </DialogHeader>
                ...
                <form onSubmit={submitHandler} className="p-5 space-y-5">
                    ...
                    <div className="flex flex-col items-center mb-6">
                        <div className="relative group">
                            {/* Avatar Display */}
                            <div className="w-24 h-24 rounded-full overflow-hidden bg-gradient-to-br from-emerald-100 to-emerald-200 dark:from-zinc-700 dark:to-zinc-800 border-4 border-white dark:border-zinc-700 shadow-lg">
                            ...
                            <button
                                ...
                                className="absolute bottom-0 right-0 w-8 h-8 bg-emerald-500 hover:bg-emerald-600 rounded-full flex items-center justify-center shadow-lg transition-all border-2 border-white dark:border-zinc-800"
                            >
                        ...
                        {/* Upload Button (shown when new photo selected) */}
                        {profilePhotoFile && (
                            <div className="mt-3 flex items-center gap-2">
                                <Button
                                    ...
                                    className="h-8 px-4 bg-emerald-500 hover:bg-emerald-600 text-white text-xs rounded-lg"
                                >
                                    {photoLoading ? (
                                        <>
                    ...
                    {/* Skills */}
                    <div className="space-y-2">
                        <Label htmlFor="skills" className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center gap-2">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
                                            <Check size={12} />
                                            {resumeFile ? 'Selected (Click Save to upload)' : 'Current Resume'}
                                        </p>
                                    </div>
                                </div>
                                <button
