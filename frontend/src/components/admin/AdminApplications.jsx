          ...
          try {
            ...
            if (appRes.data.success && appRes.data.job?.applications) {
              allApplications.push(
                ...appRes.data.job.applications.map((app) => ({
                  ...app,
                  jobTitle: job.title,
                  jobId: job._id,
                  company: job.company,
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 pt-24 relative z-10">
        ...
        >
          {[
            ...
            <div
              key={idx}
              className="relative p-4 bg-[#111111] border border-white/10 rounded-sm"
            >
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      {/* Status */}
                      <Badge
                        className={`${config.color} rounded-sm text-[10px] uppercase`}
                      >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        onClick={() =>
                          window.open(app.applicant?.profile?.resume, "_blank")
                        }
                        size="sm"
                        variant="outline"
