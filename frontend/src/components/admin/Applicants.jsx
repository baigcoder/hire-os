    ...
    return (
      <div className="mt-4 p-4 rounded-xl border bg-emerald-900/10 border-emerald-500/30">
        ...
        <p className="text-xs text-gray-400 mt-2">
          No risk flags detected on this application.
        </p>
      </div>
    );
  }
          ...
          <Table>
            <TableHeader className="bg-white/5">
              <TableRow className="border-white/5 hover:bg-white/5">
                <TableHead className="text-gray-400 font-bold w-[300px]">
                  Candidate
                </TableHead>
                ...
                <TableHead className="text-gray-400 font-bold text-center">
                  Status
                </TableHead>
            ...
            <TableBody>
              {loading ? (
                ...
                job.applications.map((app) => (
                  <TableRow
                    key={app._id}
                    className="border-white/5 hover:bg-white/5 ml-0 transition-colors group"
                  >
                    <TableCell>
                    ...
                    <TableCell>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`text-xs font-bold ${!app.resumeScore || app.resumeScore < 50 ? "text-red-500" : app.resumeScore < 70 ? "text-yellow-500" : "text-green-500"}`}
                        >
                          {app.resumeScore || 0}%
                        </span>
                      </div>
                          ...
                          <DialogContent className="bg-[#111] border-white/10 text-white max-w-2xl">
                                ...
                                <div className="flex gap-2">
                                  {app.status !== "accepted" && (
                                    <Button
                                      ...
                                      onClick={() =>
                                        handleStatusUpdate("Accepted", app._id)
                                      }
                                    >
                                      Accept
                                    </Button>
                                  ...
                                  {app.status !== "rejected" && (
                                    <Button
                                      ...
                                      variant="destructive"
                                      onClick={() =>
                                        handleStatusUpdate("Rejected", app._id)
                                      }
                                    >
                                      Reject
                                    </Button>
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-4">
                              <div className="space-y-4">
                                ...
                                <Button
                                  variant="outline"
                                  className="w-full border-dashed border-gray-700 hover:border-white/20 hover:text-white"
                                >
