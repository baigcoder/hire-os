    ...
    const verifyToken = async () => {
      ...
      try {
        const response = await axios.get(
          `${USER_API_END_POINT}/verify-reset-token/${token}`,
        );
                  ...
                  {password && (
                    <div className="mt-2">
                      ...
                      <p className="text-xs text-gray-400">
                        Strength:{" "}
                        <span
                          className={`${passwordStrength >= 4 ? "text-green-400" : "text-yellow-400"}`}
                        >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className={`w-full pl-12 pr-12 py-3 bg-white/5 border rounded-xl text-white placeholder-gray-500 focus:outline-none transition-all ${
