...
import {
    CreditCard, AlertCircle, ArrowLeft, RefreshCw, ShieldCheck, Lock, Terminal
} from 'lucide-react';
            ...
            <div className="min-h-screen bg-[#0A0A0A] font-['Space_Grotesk',sans-serif]">
                ...
                <div className="container mx-auto px-4 py-16 relative z-10">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-md mx-auto text-center">
                        ...
                        <h1 className="text-2xl font-bold text-white uppercase tracking-wider mb-4">Payment Cancelled</h1>
                        <p className="text-gray-600 text-sm font-mono mb-8">Transaction aborted. No charges applied to your account.</p>
                        <div className="flex gap-4 justify-center">
                            <Button variant="outline" onClick={() => navigate('/')} className="border-white/20 text-gray-400 hover:bg-white/5 rounded-sm uppercase tracking-wider text-xs">
                                <ArrowLeft className="w-4 h-4 mr-2" /> Home
                            </Button>
                            <Button onClick={() => navigate('/company/register')} className="bg-[#FFD700] text-black hover:bg-[#FFE44D] rounded-sm uppercase tracking-wider text-xs font-bold">
            ...
            <div className="container mx-auto px-4 py-16 relative z-10">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-lg mx-auto">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold uppercase tracking-wider mb-2">Complete Payment</h1>
                        <p className="text-gray-600 font-mono text-xs">Redirecting to secure payment gateway</p>
                    </div>
                            ...
                            {amount && (
                                <>
                                    ...
                                    <div className="flex justify-between text-lg font-bold">
                                        ...
                                        <span className="text-[#FFD700] font-mono">Rs {parseInt(amount).toLocaleString()}</span>
                                    </div>
                                </>
                            )}
                        </div>
