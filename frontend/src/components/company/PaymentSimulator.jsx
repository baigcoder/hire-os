...
import {
    CreditCard, Lock, CheckCircle, XCircle, Loader2,
                        ...
                        <Card className="bg-zinc-900/50 border-zinc-800 text-left mb-8">
                            ...
                            <CardContent className="space-y-4">
                                <div className="p-4 bg-zinc-800/50 rounded-xl">
                                    ...
                                    <p className="text-white font-semibold">{registrationResult.company?.name}</p>
                                </div>
                                <div className="p-4 bg-zinc-800/50 rounded-xl">
                                    <p className="text-sm text-gray-500">Admin Email</p>
                                    <p className="text-white font-semibold">{registrationResult.admin?.email}</p>
                                </div>
                                <div className="p-4 bg-zinc-800/50 rounded-xl">
                                    <p className="text-sm text-gray-500">Subscription</p>
                                    <p className="text-yellow-500 font-semibold">
                                        {registrationResult.plan?.name} - Rs {registrationResult.plan?.price?.toLocaleString()}/month
                                    </p>
                                </div>
                    ...
                    <Card className="bg-zinc-900/80 border-zinc-800 backdrop-blur-xl">
                        ...
                        <CardContent className="pt-6 space-y-6">
                            ...
                            <div className="text-center p-4 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-xl border border-yellow-500/20">
                                ...
                                <p className="text-yellow-500 text-sm mt-1">{planName} Plan - Monthly</p>
                            </div>
                            ...
                            <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
                                ...
                                <ul className="text-gray-400 text-xs space-y-1">
                                    <li>✅ Success: <code className="text-blue-300">4242 4242 4242 4242</code></li>
                                    <li>❌ Decline: <code className="text-blue-300">4000 0000 0000 0000</code></li>
