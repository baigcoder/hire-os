  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* HUD Corner Accents */}
        <div
          className={`absolute top-0 right-0 w-4 h-4 border-t border-r ${colors.border}`}
        />
        <div
          className={`absolute bottom-0 left-0 w-4 h-4 border-b border-l ${colors.border}`}
        />
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center gap-2">
            <div
              className={`p-1.5 rounded-sm ${colors.bg} border ${colors.border}`}
            >
        ...
        <div className="mb-3">
          ...
          <p className="text-xs text-gray-500 font-mono">{alert.details}</p>
        </div>
        ...
        {alert.confidence && (
          <div className="mb-4">
            <div className="flex justify-between items-center mb-1">
              ...
              <span
                className={`text-[10px] font-bold ${colors.text} font-mono`}
              >
                {alert.confidence}%
              </span>
            </div>
