...
import {
    ...
    Eye, Calendar, Building, ArrowLeft, Search,
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            ...
                            <p className="text-gray-400 mt-1">
                                Jobs posted by your CEO • View applications and manage candidates
                            </p>
                        </div>

                        <div className="flex items-center gap-2 bg-yellow-500/10 text-yellow-400 px-4 py-2 rounded-xl border border-yellow-500/20">
                            <AlertCircle size={18} />
                            <span className="text-sm font-medium">Only CEOs can post new jobs</span>
                        </div>
                    </div>
                </motion.div>
                ...
                {loading ? (
                    ...
                    >
                        ...
                        <p className="text-gray-500">
                            {searchQuery ? 'Try adjusting your search' : 'Your CEO hasn\'t posted any jobs yet'}
                        </p>
                    </motion.div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredJobs.map((job, index) => (
                            ...
                            >
                                <Card className="bg-[#0a0a0a] border-white/10 hover:border-white/20 transition-all cursor-pointer group"
