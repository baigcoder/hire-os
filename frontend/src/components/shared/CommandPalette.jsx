...
const CommandPalette = ({ isOpen, onClose, onShowShortcuts }) => {
  ...
  const commands = [
    ...
    // Tools
    {
      ...
      action: () => navigate("/student/dashboard?tab=skill-gap"),
    },
    {
      id: "mock-test",
      category: "TOOLS",
      icon: Briefcase,
      label: "Practice MCQ Tests",
      action: () => navigate("/student/dashboard?tab=tests"),
    },
    {
      id: "interview",
      category: "TOOLS",
      ...
      action: () => navigate("/student/dashboard?tab=interview"),
    },
                ...
                <div key={category} className="mb-2">
                  ...
                  {cmds.map((cmd) => {
                    ...
                    return (
                      ...
                      >
                        <Icon
                          className={`w-4 h-4 ${isSelected ? "text-[#FFD700]" : ""}`}
                        />
                        ...
                        <ChevronRight
                          className={`w-4 h-4 transition-opacity ${isSelected ? "opacity-100 text-[#FFD700]" : "opacity-0"}`}
                        />
                      </button>
                    );
                  })}
