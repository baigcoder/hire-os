  ...
  const analysisData = {
    ...
    checks: {
      ...
      grammar: {
        score: 88,
        status: "pass",
        issues: ["Passive voice usage in Exp. 2"],
      },
                ...
                <CardContent className="flex flex-col items-center justify-center p-6 relative z-10">
                  <div className="w-48 h-48 relative flex items-center justify-center">
                      ...
                      <PieChart>
                        <Pie
                          data={[
                            ...
                            { value: 100 - analysisData.overallScore },
                          ]}
                          innerRadius={60}
                          outerRadius={80}
                          startAngle={180}
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center -mt-8">
                      ...
                      <span className="text-emerald-400 text-sm font-bold bg-emerald-500/10 px-2 py-1 rounded mt-2">
                        Top 10%
                      </span>
                    </div>
                  </div>
                  <p className="text-center text-gray-400 mt-[-20px]">
                    Your profile is a{" "}
                    <span className="text-white font-bold">Strong Match</span>{" "}
                    for this role.
                  </p>
                </CardContent>
                {/* Decorative Glow */}
          ...
          <div className="lg:col-span-2 space-y-6">
            <Tabs defaultValue="visual" className="w-full">
              <TabsList className="bg-[#0a0a0a] border border-white/10 p-1 rounded-xl">
                <TabsTrigger
                  value="visual"
                  className="data-[state=active]:bg-yellow-500 data-[state=active]:text-black rounded-lg transition-all"
                  ...
                  <Card className="bg-yellow-500/5 border-yellow-500/20">
                    <CardContent className="p-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {analysisData.missing_keywords.map((kw, i) => (
                          <Badge
                            key={i}
                            variant="outline"
                            className="border-yellow-500/30 text-yellow-200 bg-yellow-500/10 hover:bg-yellow-500/20 transition-colors"
                          >
                            + {kw}
                          </Badge>
                        ))}
                      ...
                      <p className="text-sm text-gray-400 mt-4 leading-relaxed">
                        Adding these keywords to your "Skills" or "Experience"
                        section could increase your match probability by{" "}
