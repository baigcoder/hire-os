...
const CareerTimeline = () => {
  ...
  const fetchTimeline = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`${CAREER_INSIGHTS_API_END_POINT}/timeline`, {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 grid grid-cols-2 lg:grid-cols-1 gap-4">
          {[
            ...
            >
              <div
                className={`w-10 h-10 rounded-lg bg-${stat.color}-500/10 flex items-center justify-center mb-3`}
              >
            ...
            {timeline.length === 0 ? (
              ...
              >
                ...
                <p className="text-gray-500 mb-6 max-w-sm mx-auto">
                  Add your education and experience to build your career
                  timeline
                </p>
                  ...
                  {timeline.map((item, idx) => {
                    ...
                    return (
                      ...
                      >
                        {/* Icon */}
                        <div
                          className={`relative z-10 w-16 h-16 rounded-xl ${iconColorClass} border flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}
                        >
