          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex-1 text-left">
                <h4
                  className={`font-bold ${view === "calendar" ? "text-black" : "text-white"}`}
                >
                  Calendar
                </h4>
                <p
                  className={`text-sm ${view === "calendar" ? "text-black/70" : "text-gray-500"}`}
                >
            ...
            >
              <div className="flex-1 text-left">
                <h4
                  className={`font-bold ${view === "list" ? "text-black" : "text-white"}`}
                >
                  List
                </h4>
                <p
                  className={`text-sm ${view === "list" ? "text-black/70" : "text-gray-500"}`}
                >
            ...
            >
              <div className="flex-1 text-left">
                <h4
                  className={`font-bold ${view === "upcoming" ? "text-black" : "text-white"}`}
                >
                  Upcoming
                </h4>
                <p
                  className={`text-sm ${view === "upcoming" ? "text-black/70" : "text-gray-500"}`}
                >
      ...
      >
        {view === "calendar" ? (
          <>
            ...
            <div className="grid grid-cols-7 gap-1 mb-2">
              {weekDays.map((day) => (
                <div
                  key={day}
                  className="text-center text-xs font-semibold text-gray-500 py-2 uppercase"
                >
                  {day}
                </div>
              ))}
            ...
            <div className="grid grid-cols-7 gap-1">
              {days.map((day, idx) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`text-sm font-medium ${isSelected ? "text-black" : day.isCurrentMonth ? "text-white" : "text-gray-600"}`}
                    >
                      {day.date.getDate()}
                    </span>
                    {hasInterviews && (
                    ...
                    <div className="space-y-3">
                      {getInterviewsForDate(selectedDate).map((interview) => (
                        <div
                          ...
                          onClick={() =>
                            interview.jobId &&
                            navigate(`/description/${interview.jobId}`)
                          }
          ...
          <div className="space-y-3">
            ...
            {(view === "upcoming" ? upcomingInterviews : interviews).length ===
            0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-sm">
                  Apply to jobs and get invited to interviews
                </p>
              </div>
            ) : (
