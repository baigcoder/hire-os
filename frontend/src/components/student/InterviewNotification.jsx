...
const InterviewNotification = ({ application }) => {
  ...
  return (
    <Card
      className={`w-full mb-4 border-l-4 ${!application.interviewDetails?.viewed ? "border-l-blue-500" : "border-l-gray-300"} shadow-md ${!application.interviewDetails?.viewed ? "bg-blue-50" : ""}`}
    >
