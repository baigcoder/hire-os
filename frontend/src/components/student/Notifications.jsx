    ...
    const fetchUpcomingInterviews = async () => {
        try {
            ...
            if (res.data.success) {
                ...
                const upcomingInterviews = res.data.interviews.filter(interview => 
                        ...
                        return (
                            ...
                            >
                                <div className="flex justify-between items-start mb-2">
                                    ...
                                    <Badge 
                                        className={isUpcoming ? 'bg-yellow-100 text-yellow-800' : 'bg-blue-100 text-blue-800'}
                                    >
                                ...
                                <div className="flex items-center gap-2 text-sm font-medium mb-3">
                                    <AlertCircle className={`h-4 w-4 ${isUpcoming ? 'text-yellow-600' : 'text-blue-600'}`} />
                                    <span>{isUpcoming ? 'Starting soon' : `Time remaining: ${getTimeRemaining(interviewDate)}`}</span>
                                </div>
