...
const SalaryInsights = () => {
  ...
  const fetchSalaryInsights = async (isRefresh = false) => {
    try {
      ...
      if (res.data.success) {
        ...
        setUserLocation(
          res.data.userLocation || res.data.insights?.userLocation || null,
        );
  ...
  const formatSalary = (amount) => {
    ...
    if (currency === "PKR") {
      ...
      if (amount >= 100000)
        return `${symbol}${(amount / 100000).toFixed(1)} Lac`;
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1 flex items-center gap-2">
            ...
            {(userLocation || insights?.locationInsight) && (
              <Badge
                variant="outline"
                className="border-[#FFD700]/30 text-[#FFD700] ml-2"
              >
          ...
          <div className="relative mb-8">
            <div className="flex items-end justify-between h-40 gap-4">
              ...
              <div className="flex flex-col items-center">
                <div
                  className="w-16 bg-gradient-to-t from-[#FFD700]/20 to-[#FFD700]/60 rounded-t-lg mb-2"
                  style={{ height: "60%" }}
                />
              ...
              <div className="flex flex-col items-center">
                <div
                  className="w-16 bg-gradient-to-t from-emerald-500/20 to-emerald-500/60 rounded-t-lg mb-2"
                  style={{ height: "100%" }}
                />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-400">
                      Growth Potential with Upskilling
                    </p>
            ...
            <div className="flex flex-wrap gap-2">
              {userSkills.length > 0 ? (
                ...
                <p className="text-gray-500 text-sm">
                  Add skills for personalized insights
                </p>
              )}
            </div>
          </div>
