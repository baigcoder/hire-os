...
const TrialWelcomeModal = ({ isOpen, onClose, userName, trialEndDate }) => {
  ...
  const features = [
    {
      ...
      desc: "Get professional feedback",
    },
    {
      icon: Brain,
      title: "Mock MCQ Tests",
      desc: "Gemini AI-powered practice",
    },
              ...
              <div className="bg-[#111111] border border-white/10 rounded-lg p-4 mb-6">
                <div className="flex items-center justify-center gap-4">
                  ...
                  <div className="text-center">
                    <p className="text-3xl font-black text-[#FFD700] font-mono">
                      {daysRemaining}
                    </p>
