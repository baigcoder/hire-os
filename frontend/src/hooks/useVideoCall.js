...
export const useVideoCall = (socket, interviewId, options = {}) => {
    ...
    }, [socket, interviewId, localStream, createPeerConnection, initializeMedia, addLocalTracks]);
    ...
    }, [socket, handleOffer, handleAnswer, handleIceCandidate, localStream, createOffer]);
