...
export const updateApplicationStatus = async (applicationId, status, interviewDate = null, interviewDetails = null) => {
  try {
    let payload = { status };
    ...
    const res = await import('axios').then(module => module.default.post(
